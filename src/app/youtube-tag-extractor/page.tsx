...
export default function YouTubeTagExtractorPage() {
  ...
  const extractTags = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        const mockTags = [
          'gaming', 'tutorial', 'gameplay', 'walkthrough',
          'tips and tricks', 'strategy guide', 'game review',
          'lets play', 'gaming channel', 'video games'
        ];
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="transform transition-all duration-700 hover:scale-105">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              YouTube Tag <span className="text-yellow-300">Extractor</span>
            </h1>
          </div>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in-up">
            Extract tags from any YouTube video to optimize your own content
          </p>
          ...
          <div className="max-w-xl mx-auto mt-10 bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 animate-fade-in-delayed">
            <div className="text-left">
              <div className="text-white/60 text-sm mb-2">Example Tags</div>
              <div className="flex flex-wrap gap-2">
                {['gaming', 'tutorial', 'howto', 'tech'].map((tag, index) => (
                  <span
                    key={index}
      ...
      <div className="container mx-auto px-6 mb-16">
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          <form onSubmit={extractTags} className="max-w-3xl mx-auto">
            <div className="mb-8">
          ...
          {extractedTags.length > 0 && (
            <div className="mt-12 max-w-3xl mx-auto">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Extracted Tags</h2>
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                  ...
                  <button
                    onClick={() => copyToClipboard(extractedTags.join(', '))}
