...
const relatedTools = [
  ...
  },
  {
    ...
    description: 'Extract tags from existing videos',
...
export default function YouTubeTitleExtractorPage() {
  ...
  const extractTitle = async (e: React.FormEvent) => {
    e.preventDefault();
    setError('');
    setIsLoading(true);
    ...
    try {
      ...
      setTimeout(() => {
        const mockTitle = "Ultimate Guide: How to Create Viral YouTube Content in 2023 | Pro Tips & Tricks";
        setExtractedTitle(mockTitle);
        setIsLoading(false);
      }, 1500);
    } catch (err) {
      setError('Failed to extract title. Please try again.');
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="transform transition-all duration-700 hover:scale-105">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              YouTube Title <span className="text-yellow-300">Extractor</span>
            </h1>
          </div>
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in-up">
            Extract titles from any YouTube video to inspire your content
          </p>
          ...
          <div className="max-w-xl mx-auto mt-10 bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 animate-fade-in-delayed">
            <div className="text-left">
              ...
              <div className="text-white font-medium">
                How I Built a Successful YouTube Channel With Zero Experience | My Journey
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 mb-16">
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          <form onSubmit={extractTitle} className="max-w-3xl mx-auto">
            <div className="mb-8">
            ...
            <div className="text-center">
              <button
                ...
                className="inline-flex items-center px-6 py-3 rounded-xl bg-gradient-to-r from-pink-500 to-rose-600 text-white font-medium shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105"
              >
                {isLoading ? (
                  <>
                    <svg
          ...
          {extractedTitle && (
            <div className="mt-12 max-w-3xl mx-auto">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Extracted Title</h2>
              
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                <div className="mb-6">
                  <p className="text-lg font-medium text-gray-800 mb-4">{extractedTitle}</p>
                  <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-200">
                    <span className="text-sm text-gray-500">
                      Title length: {extractedTitle.length} characters
                    </span>
                    <button
                      onClick={() => copyToClipboard(extractedTitle)}
